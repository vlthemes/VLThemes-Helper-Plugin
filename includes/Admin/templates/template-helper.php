...
<div class="vlt-masonry-grid">
	...
	<div class="vlt-masonry-item">
		<div class="vlt-widget">
			<div class="vlt-widget__title">
				<mark><?php esc_html_e( 'Documentation', 'vlthemes-toolkit' ); ?></mark>
			</div>

			<div class="vlt-widget__content">
				<p><?php esc_html_e( 'Got a question? Check our Documentation or Knowledge Base first — the answer might already be there!', 'vlthemes-toolkit' ); ?></p>
		...
		<div class="vlt-widget">
			<div class="vlt-widget__title">
				<mark><?php esc_html_e( 'Changelog', 'vlthemes-toolkit' ); ?></mark>
			</div>

			<div class="vlt-widget__content">
				<ul class="vlt-styled-list">
					<li><?php esc_html_e( 'Here\'s what\'s new and improved!', 'vlthemes-toolkit' ); ?></li>
					<li><?php esc_html_e( 'We\'ve made some updates — check them out below!', 'vlthemes-toolkit' ); ?></li>
					<li><?php esc_html_e( 'Fresh updates to make your experience even better.', 'vlthemes-toolkit' ); ?></li>
				</ul>

				<a target="_blank" rel="noopener" href="<?php echo esc_url( $this->changelog_url . $this->theme_slug ); ?>" class="button button-primary mt-sm">
					<?php esc_html_e( 'Visit Changelog', 'vlthemes-toolkit' ); ?>
				</a>
			</div>
		</div>
	...
	<div class="vlt-masonry-item">
		<div class="vlt-widget">
			<div class="vlt-widget__title">
				<mark><?php esc_html_e( 'Support Form', 'vlthemes-toolkit' ); ?></mark>
			</div>

			<div class="vlt-widget__content">
				<p><?php esc_html_e( 'If you did not find an answer to your question, please submit a support ticket and describe your issue in detail.', 'vlthemes-toolkit' ); ?></p>
				...
				<div class="notice notice-info inline mt-sm">
					<p>
						...
						printf(
							...
							esc_html__( 'Please read a %s before submitting a ticket and make sure that your question is related to our product issues.', 'vlthemes-toolkit' ),
							'<a target="_blank" href="' . esc_url( $this->support_policy_url ) . '">' . esc_html__( 'Support Policy', 'vlthemes-toolkit' ) . '</a>'
						);
						?>
					</p>
				</div>
				...
				<div class="notice notice-info inline mt-sm">
					<p>
						...
						printf(
							...
							esc_html__( 'Our team will review your request and respond within %s.', 'vlthemes-toolkit' ),
							'<strong>' . esc_html__( 'two business days', 'vlthemes-toolkit' ) . '</strong>'
						);
						?>
					</p>
				</div>
				...
				<div class="notice notice-info">
					<p>
						...
						printf(
							...
							esc_html__( 'If you got %s through a subscription (for example, from Envato Elements), please remember that item support isn\'t included.', 'vlthemes-toolkit' ),
				...
				<a target="_blank" rel="noopener" href="<?php echo esc_url( $this->support_url ); ?>" class="button button-primary mt-sm">
					<?php esc_html_e( 'Create a Ticket', 'vlthemes-toolkit' ); ?>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="vlt-masonry-item">
		<div class="vlt-widget">
			...
			<div class="vlt-widget__title">
				<mark><?php esc_html_e( 'Our Partners *', 'vlthemes-toolkit' ); ?></mark>
			</div>
			...
			<div class="vlt-widget__content">
				...
				<div class="postbox-header pb-sm">
					...
					<a target="_blank" href="<?php echo esc_url( $this->elementor_partner_url ); ?>" class="button button-primary"><?php esc_html_e( 'Explore More', 'vlthemes-toolkit' ); ?></a>

				</div>

				<p class="mt-sm"><?php esc_html_e( 'A visual drag-and-drop builder for designing forms, posts, pages, and more.', 'vlthemes-toolkit' ); ?></p>
				...
				<div class="postbox-header pb-sm mt-lg">
					...
					<a target="_blank" href="<?php echo esc_url( $this->fornex_partner_url ); ?>" class="button button-primary"><?php esc_html_e( 'Explore More', 'vlthemes-toolkit' ); ?></a>

				</div>

				<p class="mt-sm"><?php esc_html_e( 'A hosting provider offering dedicated servers, VPS, shared hosting, VPNs, and backup services.', 'vlthemes-toolkit' ); ?></p>

				<p class="small mt-sm"><?php esc_html_e( '* Here we provide some partners and services that we use.', 'vlthemes-toolkit' ); ?></p>
