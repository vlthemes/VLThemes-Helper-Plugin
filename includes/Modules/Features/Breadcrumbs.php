...
class Breadcrumbs extends BaseModule
{
	...
	private function register_functions()
	{
		if (! function_exists('vlt_breadcrumbs')) {
			/**
			 * Output breadcrumbs (HTML + optional JSON-LD)
			 *
			 * @param array $args Optional arguments to override defaults.
			 * @param bool  $echo Whether to echo or return the output.
			 * @return string|void Breadcrumbs HTML if $echo is false.
			 */
			function vlt_breadcrumbs($args = array(), $echo = true)
			{
				return \VLT\Helper\Modules\Features\Breadcrumbs::render($args, $echo);
			}
		}

		if (! function_exists('vlt_get_breadcrumbs')) {
			/**
			 ...
			 */
			function vlt_get_breadcrumbs($args = array())
			{
				return \VLT\Helper\Modules\Features\Breadcrumbs::render($args, false);
			}
		}
	}
	 ...
	 * @return string|void Breadcrumbs HTML if $echo is false.
	 */
	public static function render($args = array(), $echo = true)
	{
		$defaults = array(
			'show_home'       => true,
			'show_on_home'    => false,
		 ...
		 */
		$args = apply_filters('vlt_helper_breadcrumbs_args', $args);
		 ...
		 */
		$modified = apply_filters('vlt_helper_breadcrumbs_items', array($breadcrumbs, $schema_items, $args));
		...
		if (! empty($breadcrumbs)) {
			...
			$allowed_tags  = array('nav', 'div', 'section');
