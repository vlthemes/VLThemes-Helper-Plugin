...
use VLT\Helper\Modules\Integrations\Elementor\Extensions\HeaderFooterExtension;
...
require_once __DIR__ . '/Elementor/Extensions/HeaderFooterExtension.php';
...
class Elementor extends BaseModule
{
	...
	private function init_extensions()
	{
		$this->extensions = [
			...
			'header_footer'    => new HeaderFooterExtension(),
		];
	}
